            ...
            <div class="viewer-footer">
                <div class="viewer-title"></div>
                    <ul class="viewer-toolbar">       
                        <li class="viewer-zoom-in" data-action="zoom-in" title="zoom in"></li>
                        <li class="viewer-zoom-out" data-action="zoom-out" title="zoom out"></li>
                        <li class="viewer-one-to-one" data-action="one-to-one" title="origin size"></li>
                        <li class="viewer-reset" data-action="reset" title="reset"></li>
                        <li class="viewer-prev" data-action="prev" title="previous photo"></li>
                        <li class="viewer-play" data-action="play" title="play"></li>
                        <li class="viewer-next" data-action="next" title="next photo"></li>
                        <li class="viewer-rotate-left" data-action="rotate-left" title="rotate left"></li>
                        <li class="viewer-rotate-right" data-action="rotate-right" title="rotate right"></li>
